...
/**
 * @file
 * This is gva - services carousel.
 */

if (!class_exists('GaviasEnzioElementGvaServicesCarousel')) :
  /**
   * Gavias Enzio Element Gva Services Carousel.
   */
  class GaviasEnzioElementGvaServicesCarousel {
               ...
               <?php for ($i = 1; $i <= 10; $i++) {
                  ...
                  <?php if ($$title) {
                    ?>
                     ...
                     <?php if ($$icon) {
                        ?><div class="icon"><a href="<?php print $$link ?>"><i class="<?php print $$icon ?>"></i></a></div><?php
                     } ?>         
                     <?php if ($$title) {
                        ?><div class="title"><a href="<?php print $$link ?>"><?php print $$title ?></a></div><?php
                     } ?>
                     </div></div>
                    <?php
                  } ?>    
