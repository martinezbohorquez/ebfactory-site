...
/**
 * @file
 * This is gva - our history.
 */

if (!class_exists('GaviasEnzioElementGvaOurHistory')) :
  /**
   * Gavias Enzio Element Gva Our History.
   */
  class GaviasEnzioElementGvaOurHistory {
    ...
    public static function renderContent($attr = [], $content = '') {
      ...
      ?>
         <?php if ($style == 'carousel') {
            ?>
            <div class="gsc-our-history-carousel <?php echo $el_class ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>> 
                    ...
                    ?>
                     ...
                     <?php if ($$title) {
                        ...
                        <div class="item"><div class="content-inner">
                           <?php if ($$year) {
                              ?><div class="year"><?php print $$year ?></div><?php
                           } ?>         
                           <?php if ($$title) {
                              ?><div class="title"><?php print $$title ?></div><?php
                           } ?>
                           <?php if ($$content) {
                              ?><div class="description"><?php print $$content ?></div><?php
                           } ?>
                        </div></div>
                        <?php
                     } ?>    
         ...
         elseif ($style == 'timeline') {
            ?>
            <div class="gsc-our-history-timeline <?php echo $el_class ?>" <?php print gavias_content_builder_print_animate_wow($animate) ?>> 
