...
/**
 * Gavias enzio font size.
 */
function gavias_enzio_font_size() {
  $size = [];
  $size[''] = '-- Default --';
  for ($i = 12; $i <= 50; $i = $i + 1) {
    $size[$i] = $i;
...
/**
 * Gavias enzio render option font.
 */
function gavias_enzio_render_option_font() {
  $fonts = gavias_enzio_fonts();
  $output = '';
...
/**
 * Gavias enzio typography font styles.
 */
function gavias_enzio_typography_font_styles($option, $selectors) {
  $output = $selectors . ' {';
...
/**
 * Gavias enzio typography enqueue google font.
 */
function gavias_enzio_typography_enqueue_google_font($font) {
  if ($font && $font != "---") {
    if (array_search($font, array_keys(gavias_enzio_fonts())) > 17) {
...
/**
 * Gavias enzio links typography font.
 */
...
/**
 * Gavias enzio options patterns.
 */
function gavias_enzio_options_patterns() {
  $output = '';
  $file_path = drupal_get_path('theme',
  'gavias_enzio');
