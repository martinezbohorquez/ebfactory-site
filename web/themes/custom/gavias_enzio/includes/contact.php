...
/**
 * Gavias enzio form contact message feedback form alter.
 */
function gavias_enzio_form_contact_message_feedback_form_alter(&$form, FormStateInterface $form_state, $form_id) {
  // Name.
  $form['name']['#weight'] = -1;
