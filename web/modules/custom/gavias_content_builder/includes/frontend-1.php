...
/**
 * Gavias_content_builder_render_el.
 */
gavias_content_builder_render_el($data = [], $content = '') {
...
if (isset($data['element_name'])) {
  if (!in_array($data['element_name'], ['gva_row', 'gva_column'])) {
    ob_start();
 ...
 */
gavias_content_builder_render_element($id = '', $settings = [], $content = '') {
$_class = 'element_' . $id;
