...
/**
 * Gavias content builder variable get.
 */
...
/**
 * Gavias content builder includes.
 */
function gavias_content_builder_includes($path, $ifiles = []) {
  if (!empty($ifiles)) {
...
/**
 * Gavias content builder render block.
 */
