...
<div id="gavias-pagebuider-wrap-settings">
   ...
   <div class="gbb-block-title">
    <strong><?php print 'Edit: ' ?><?php print $gbb_title ?> ( ID: <?php print $gbb_id ?> | <a href="<?php print Url::fromRoute('gavias_content_builder.admin.import', ['bid' => $gbb_id])->toString() ?>">Import</a> | <a href="<?php print Url::fromRoute('gavias_content_builder.admin.export', ['bid' => $gbb_id])->toString() ?>">Export</a> )</strong>
   </div>
