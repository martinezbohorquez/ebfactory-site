...
function parse_custom_animation_by_array($animArray) {
  ...
  if (isset($animArray['movey']) && $animArray['movey'] !== '') {
    $retString .= 'y:' . $animArray['movey'] . ';';
  }
  if (isset($animArray['movez']) && $animArray['movez'] !== '') {
    $retString .= 'z:' . $animArray['movez'] . ';';
  }

  if (isset($animArray['rotationx']) && $animArray['rotationx'] !== '') {
    $retString .= 'rotationX:' . $animArray['rotationx'] . ';';
  }
  if (isset($animArray['rotationy']) && $animArray['rotationy'] !== '') {
    $retString .= 'rotationY:' . $animArray['rotationy'] . ';';
  }
  if (isset($animArray['rotationz']) && $animArray['rotationz'] !== '') {
    $retString .= 'rotationZ:' . $animArray['rotationz'] . ';';
  }
  ...
  if (isset($animArray['skewx']) && $animArray['skewx'] !== '') {
    $retString .= 'skewX:' . $animArray['skewx'] . ';';
  }
  if (isset($animArray['skewy']) && $animArray['skewy'] !== '') {
    $retString .= 'skewY:' . $animArray['skewy'] . ';';
  }
  ...
  if (isset($animArray['captionperspective']) && $animArray['captionperspective'] !== '') {
    $retString .= 'transformPerspective:' . $animArray['captionperspective'] . ';';
  }
